...
# ax.remove()
plt.savefig(r'./Figs/Figure_4_b.png', dpi=600)
...
grid = plt.GridSpec(4, 1, left=0, right=1, bottom=0, top=1, wspace=0, hspace=0)
...
plt.yticks([])
plt.axis('off')
plt.text(100, 60, 'c.', fontweight='bold', fontsize=25)
# ax.remove()
