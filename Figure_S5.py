...
plt.savefig('Figs/Figure_S5_a.png', dpi=300)
...
plt.savefig('Figs/Figure_S5_b.png', dpi=300)

fig, ax = plt.subplots(figsize=(12, 16), frameon=False)
plt.subplots_adjust(left=0, right=1, bottom=0, top=1, wspace=0, hspace=0)
plt.subplot(2, 1, 1)
plt.imshow(plt.imread('Figs/Figure_S5_a.png'))
plt.xticks([])
plt.yticks([])
plt.axis('off')
plt.subplot(2, 1, 2)
plt.imshow(plt.imread('Figs/Figure_S5_b.png'))
plt.xticks([])
plt.yticks([])
plt.axis('off')
plt.savefig('Figs/Figure_S5.jpg', dpi=600)
