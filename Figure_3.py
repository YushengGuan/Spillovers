...
plt.subplots_adjust(left=0.15, bottom=0.1, right=0.98, top=0.9)
plt.subplot(2,1,1)
...
plt.ylim(0, 4500)
plt.ylabel('Energy consumption (billion $)', fontsize=12)
plt.legend(frameon=False, loc='upper left')
plt.text(-0.3, 4500*1.01, 'a.', fontsize=20, fontweight='bold')
...
plt.ylim(0, 80)
plt.ylabel('Energy consumption (EJ)', fontsize=12, labelpad=15)
plt.text(-1, 80*1.01, 'b.', fontsize=20, fontweight='bold')
plt.savefig(r'Figs/Figure_3_a&b.png', dpi=300)
# plt.show()
...
# 
# fig, ax = plt.subplots(figsize=(16, 6), frameon=False)
...
#         plt.text(-1.5, 0.21, 'c.', fontsize=25, fontweight='bold')
#     elif j == 2:
#         plt.subplot(1, 2, 2)
#         plt.yticks([-0.3, -0.15, 0, 0.15, 0.3], labels=['-30%', '-15%', '0', '15%', '30%'])
#         plt.ylim([-0.3, 0.3])
#         plt.text(0, 0.315, 'SCN2:GwC relative to SCN0')
#         plt.text(-1.5, 0.315, 'd.', fontsize=25, fontweight='bold')
#     else:
#         continue
...
#     plt.hlines(0, xmin=0, xmax=11, color='black', linewidth=0.7)
#     plt.xlim(0, 11)
...
# grid = plt.GridSpec(2, 2, left=0, right=1, bottom=0, top=1, wspace=0, hspace=0)
# plt.subplot(grid[0, :])
